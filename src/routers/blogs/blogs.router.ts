...
blogsRouter.post(BLOGS_ROUTER.BASE, baseAuthorizationMiddleWare, createBlogHandler);
blogsRouter.put(BLOGS_ROUTER.BY_ID, baseAuthorizationMiddleWare, updateBlogHandler);
blogsRouter.delete(BLOGS_ROUTER.BY_ID, baseAuthorizationMiddleWare, deleteBlogHandler);
